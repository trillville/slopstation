...
PYTHON = {
    ...
    "announce_cut_short": {"operation"},
    "announce_earcon_failed": {"err", "operation"},
    "announce_failed": {"err", "fallback", "operation"},
    ...
    "gate_match": {"closer", "confidence", "intent", "level_db", "quiet_ms", "text"},
    "gate_miss": {"confidence", "fallback", "level_db", "quiet_ms", "reason", "text"},
    ...
    "remote_auth_failed": {"reason"},
    "remote_lockout": {"failures", "lock_s"},
    "remote_request": {"dur_ms", "session", "turn"},
    "remote_request_failed": {"err"},
    "remote_throttled": {"limit"},
    "restart": {"code", "what"},
    "sentry_setup_failed": {"err"},
    ...
    "tool_error": {"err", "tool"},
    "tool_gap": {"api", "asked", "method", "path"},
