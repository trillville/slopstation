...
class Session:
    ...
    async def run(self):
        ...
        from agent.speech.audio import wake_phrase as _wake_phrase
        from agent.brain.dispatch import Dispatch
        from agent.speech.grammar_gate import GrammarGate
        from agent.speech.preroll import PrerollFeeder
    ...
    def _assistant_stages(self, transport, dispatcher, gate):
        ...
        from agent.brain.assistant import (function_schemas, server_tools,
