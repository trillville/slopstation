...
| Prowlarr | `http://<K15-IP>:9696` |
| Radarr | `http://<K15-IP>:7878` |
| Sonarr | `http://<K15-IP>:8989` |
| qBittorrent | `http://<K15-IP>:8080` |
| Homarr | `http://<K15-IP>:8575` |
...
anonymous viewing: `http://<K15-IP>:8575/boards/<name>`.
