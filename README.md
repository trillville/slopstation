...
| [docs/constraints.md](docs/constraints.md) | the hardware, Windows and library facts the code depends on, with the code and test that enforce each |
...
| `docs/` | Setup, configuration, operations, and platform constraints |
